...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->load('getAnnotations_CachedReaderService')), [0 => (\dirname(__DIR__, 4).'\\src\\Entity')]), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\DataUserRepository' => ['privates', 'App\\Repository\\DataUserRepository', 'getDataUserRepositoryService', true],
            'App\\Repository\\FotosRepository' => ['privates', 'App\\Repository\\FotosRepository', 'getFotosRepositoryService', true],
            'App\\Repository\\ProvinceRepository' => ['privates', 'App\\Repository\\ProvinceRepository', 'getProvinceRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\DataUserRepository' => '?',
