...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginFailureEvent', [0 => function () use ($container) {
            return ($container->privates['security.event_dispatcher.main.event_bubbling_listener'] ?? $container->load('getSecurity_EventDispatcher_Main_EventBubblingListenerService'));
        }, 1 => 'bubbleEvent'], 0);
